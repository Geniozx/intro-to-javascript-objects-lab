...
const Dragonair = pokemon.find(p => p.name === 'Dragonair');
const Gyaradosr = pokemon.find(p => p.name === 'Gyarados');
const Rhydon = pokemon.find(p => p.name === 'Rhydon');

game.party.push(Dragonair, Gyaradosr, Rhydon);
...
const charmanderIndex = game.party.findIndex(p => p.name === 'Charmander');
